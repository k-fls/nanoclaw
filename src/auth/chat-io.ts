/**
 * ChatIO factory — extracted from index.ts to reduce footprint in the
 * core orchestrator file.
 *
 * Creates a ChatIO adapter that routes auth-flow messages through the
 * normal channel messaging path.
 */
