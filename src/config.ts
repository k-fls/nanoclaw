...
export const EVICTION_TIMEOUT = parseInt(process.env.EVICTION_TIMEOUT || '14400000', 10); // 4h — how long an evictable container can sit before auto-stop
export const IDLE_BEFORE_EVICT = parseInt(process.env.IDLE_BEFORE_EVICT || '600000', 10); // 10min — protection period after idle before becoming evictable
